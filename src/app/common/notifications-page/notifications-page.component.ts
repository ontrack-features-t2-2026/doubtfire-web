...
export class NotificationsPageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.authenticationService.afterAuthCall((signedIn) => {
      // A session still being restored can settle after the reader has left
      // this page, and a load then would be a request nothing is waiting for.
      if (this.destroyed) {
        return;
      }
   ...
   *
   * The same shape as the dropdown in the header.
   */
