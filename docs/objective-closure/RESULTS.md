...
Maple Fox is the designated objective lead and both the student-facing and staff-facing reviewer. This assignment does not claim that Maple has performed the review. The exact remaining actions and recording templates are in [REVIEW.md](REVIEW.md); the short executed demonstration is in [DEMO.md](DEMO.md).
...
| THM-D01    | Updated source inventory, route evidence and measured findings                                                     | Reconcile remaining high-impact route/state findings and link MG-04/MG-05 artifacts, or record their missing-artifact owner/action                                                             |
